...
import com.neopet.repository.OrderRepository;
import com.neopet.response.ApiResponse;
import com.neopet.response.PaymentLinkResponse;
import com.neopet.service.OrderService;
import com.neopet.service.UserService;
import com.neopet.user.domain.OrderStatus;
import com.neopet.user.domain.PaymentStatus;
...
//			order.setOrderItems(order.getOrderItems());
			...
			new RedirectView("https://shopwithneopet.vercel.app/payment/failed");
			throw new RazorpayException(e.getMessage());
		}
